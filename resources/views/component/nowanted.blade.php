  ...
  <div class="ideacat-narrow-content">
    ...
    <div class="row row-bottom-padded-md">
      <div class="col-md-6">
        <div class="row">
          <div class="col-md-12">
            <div class="ideacat-feature animate-box" data-animate-effect="fadeInLeft">
